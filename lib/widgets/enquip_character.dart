      ...
      children: [
        ...
        Expanded(
          child: GestureDetector(
            onTap: () {
              if (ref.watch(gladiatorsContainerProvider).isEmpty) {
                ref
            ...
            child:
                (ref.watch(gladiatorsContainerProvider).isEmpty)
                    ? LottieBuilder.asset('lib/assets/animation/anim_one.json')
                    : LottieBuilder.asset('lib/assets/animation/knight.json'),
          ),
        ),
